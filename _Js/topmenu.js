		...
		switch (d)
		{
			case 1 :	
					...
					if(subMenu.length>0){
						...
						subMenu.stop().animate({"opacity":1,"height":mnH + 20},300);
						$("#mainNavi-wrap").stop().animate({height:mnH + this_s.getMenuBarHeight() + 20},300,function(){})
						$(".mn-bar").stop().show().animate({"height":mnH + 20},300,function(){});
...
$(document).ready(function(){
	$('.mn_l1').click(function(){
		$('#mainNavi').removeClass('mn-h-open');
		$('.header-slider-ovclick').hide();
